...
class SettingsChannelTest extends InterSoccer_Test_Case {
	...
	public function test_sanitize_channel_maps_aliases_and_defaults() {
		...
		$this->assertSame('prerelease', InterSoccer_Player_Management_Settings::sanitize_channel('prerelease'));
		$this->assertSame('prerelease', InterSoccer_Player_Management_Settings::sanitize_channel('beta'));
